    ...
    <>
        ...
        <section className='container p-4 lg:px-64 mx-auto'>
            <div className="flex gap-4 flex-wrap">
                ...
                <Link to={'/menu/social'} className='shadow-xl bg-white flex gap-4 flex-col items-center justify-between h-96 w-full md:w-1/3 grow p-4 rounded-xl'>
                    <div className='w-full grow rounded-lg overflow-clip'>
                        <img src="social.jpeg" className='w-full h-full object-cover' alt="" />
                    </div>
                    <h2 className='text-2xl font-bold'>Social Training</h2>
                </Link>
                <Link to={'/menu/ar'} className='shadow-xl bg-white flex gap-4 flex-col items-center justify-between h-96 w-full md:w-1/3 grow p-4 rounded-xl'>
                    <div className='w-full grow rounded-lg overflow-clip'>
                        <img src="ar.jpeg" className='w-full h-full object-cover' alt="" />
                    </div>
                    <h2 className='text-2xl font-bold'>AR Training</h2>
                </Link>
            </div>
        </section>
    </>
