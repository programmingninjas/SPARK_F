  ...
  return (
    <>
      ...
      <div className="flex container mx-auto gap-2 flex-wrap my-8">
        <div className="card bg-white mt-2 grow w-1/3">
          <h1 className="font-semibold text-xl">Evaluation Modules</h1>
          <div className="flex mt-4 gap-2 flex-wrap">
            <Link to="/scales" className="card flex flex-col justify-between h-40 w-1/3 grow bg-primary text-light transition-all hover:grow-[2] duration-300 hover:z-20 shadow-xl hover:shadow-primary/40 hover:bg-accent">
              ...
              <div>
                ...
                <h1 className="opacity-70">Developmental Age Scale</h1>
              </div>
            </Link>
            <Link to="/scales" className="card flex flex-col justify-between h-40 w-1/3 grow bg-primary text-light transition-all hover:grow-[2] duration-300 hover:z-20 shadow-xl hover:shadow-primary/40 hover:bg-accent">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
              ...
              <div>
                <h1 className="font-semibold uppercase">Scales</h1>
                <h1 className="opacity-70">ISAA Scale</h1>
              </div>
            </Link>
            <Link to='/reactiontime' className="card flex flex-col justify-between h-40 w-1/3 grow bg-primary text-light transition-all hover:grow-[2] duration-300 hover:z-20 shadow-xl hover:shadow-primary/40 hover:bg-accent">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23-.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611A48.309 48.309 0 0112 21c-2.773 0-5.491-.235-8.135-.687-1.718-.293-2.3-2.379-1.067-3.61L5 14.5" />
              </svg>

              <div>
                <h1 className="font-semibold uppercase">Physical Reaction Time</h1>
